$(function () {
    ...
    // 2. Create a function for creating enemy objects. They must inherit
    // from characters and have isDead public method
    //
    // isDead method:
    // returns true if hp <= 0
    
    // 3. Create a function for creating player objects. They must inherit
    // from characters and have attack and drinkPotion public methods
    //
    // attack method:
    // receive an enemy parameter and substract from his hp the
    // difference between player's strength and enemy defense. Also, 
    // player's ap is reduced by 1. 
    // If player's ap is 0 it doesn't have any effect
    // If enemy's hp it doesn't have any effect
    //
    // drinkPotion method:
    ...
    // Example:
    // bindActions(characters[0]);
    // fillCharacterElement(characters[0]);
